...
/***/ function(module, exports, __webpack_require__) {
	...
	var excerpts = __webpack_require__(162);
	...
	var Recap = React.createClass({displayName: "Recap",
	  render: function() {
	    if (!this.props.wpm) {
	      return null;
	    }
	    return (
	      React.createElement("div", {className: "recapOverlay"}, 
	        React.createElement("h2", null, "Congrats!"), 
	        React.createElement("div", null, "WPM: ", this.props.wpm), 
	        React.createElement("div", null, "Errors: ", this.props.errorCount)
	      )
	    );
	  }
	});
	...
	var ScoreBoard = React.createClass({displayName: "ScoreBoard",
	  render: function() {
	    return (
	      React.createElement("span", {className: "scoreBoard"}, 
	    ...
	    return (
	      React.createElement("div", {className: "centered"}, 
	        React.createElement("div", {class: "header"}, 
	          ...
	          React.createElement(ScoreBoard, {onRestart: this.restartGame})
	        ), 
	        ...
	        React.createElement(TextInput, {
	          ...
	          error: this.state.error}), 
	        React.createElement(Clock, {elapsed: this.state.timeElapsed}), 
	        React.createElement(Recap, {
	...
	React.render(React.createElement(App, {excerpts: excerpts}), document.getElementById('container'));
...
/***/ function(module, exports) {
	...
	var excerpts = [ "The mental features discoursed of as the analytical, are, in themselves, but little susceptible of analysis. We appreciate them only in their effects. We know of them, among other things, that they are always to their possessor, when inordinately possessed, a source of the liveliest enjoyment.",
